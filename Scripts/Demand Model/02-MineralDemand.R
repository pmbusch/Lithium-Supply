...
stationary <- read.csv("Parameters/Demand Intermediate Results/stationaryPower.csv")
...
# Sodium for SSPS
stationary_SIB <- read.csv("Parameters/Demand Intermediate Results/Sodium_stationaryPower.csv")
